...
var theme = {
   ...
   * Bootstrap validation - Only sends messages if form has class ".comment-form" and is validated and shows success/fail messages
   */
  /*forms: () => {
    (function () {
      "use strict";
            ...
            form.addEventListener(
              ...
              function (event) {
                ...
                if (form.checkValidity() === true) {
                  ...
                  // Send message only if the form has class .comment-form
                  var isContactForm = form.classList.contains("comment-form");
                  if (isContactForm) {
                    var data = new FormData(form);
                    var alertClass = "alert-danger";
                    fetch("http://codeweber.test/wp-comments-post.php", {
                      method: "post",
                      body: data,
                    })
                      .then((data) => {
