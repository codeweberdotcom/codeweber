	...
	<div class="row mb-5">
		...
		<span class="col-md-6 col-lg-3">
			<p class="form-row form-row-last">
				<button type="submit" class="button btn btn-primary rounded w-100 flex-grow-1" name="apply_coupon" value="<?php esc_attr_e('Apply coupon', 'woocommerce'); ?>"><?php esc_html_e('Apply coupon', 'woocommerce'); ?></button>
			</p>
		</span>
	</div>
