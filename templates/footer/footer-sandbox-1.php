  <footer class="bg-navy text-inverse">
     <div class="container pt-15 pt-md-17 pb-13 pb-md-15">
        <div class="d-lg-flex flex-row align-items-lg-center">
           ...
           <a href="#" class="btn btn-primary <?php echo ButtonStyleCustomizer(); ?><?php echo ButtonStyleCustomizer(); ?><?php echo ButtonStyleCustomizer(); ?> mb-0 text-nowrap"><?php esc_html_e('Try It For Free', 'codeweber'); ?></a>
        </div>
        <!--/div -->
                       ...
                       <form action="https://elemisfreebies.us20.list-manage.com/subscribe/post?u=aa4947f70a475ce162057838d&amp;id=b49ef47a9a" method="post" id="mc-embedded-subscribe-form2" name="mc-embedded-subscribe-form" class="validate dark-fields" target="_blank" novalidate>
                          <div id="mc_embed_signup_scroll2">
                             <div class="mc-field-group input-group form-floating">
                                ...
                                <input type="submit" value="<?php esc_html_e('Join', 'codeweber'); ?>" name="subscribe" id="mc-embedded-subscribe2" class="btn btn-primary <?php echo ButtonStyleCustomizer(); ?><?php echo ButtonStyleCustomizer(); ?>">
                             </div>
