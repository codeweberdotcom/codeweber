  ...
  <?php if ($block->background_video_bool == true) { ?>
    ...
    <div class="container pt-7 pt-md-11 pb-8">
      <div class="row gx-0 gy-10 align-items-center">
        <div class="col-lg-6 pe-lg-10 <?php echo $block->column_class_1; ?>" data-cues="slideInDown" data-group="page-title" data-delay="600">
        ...
        <!-- /column -->
        <div class="col-lg-6  mb-n15 <?php echo $block->column_class_2; ?>" data-cues="slideInDown">
