...
/**
 * Set Featured Project Image into Repeater First Image Project
 * Projects
...
add_action('acf/save_post', function ($post_id) {
	...
	if ($post_type == 'projects') {
		$value = array();
		if (have_rows('izobrazheniya', $post_id)) :
			while (have_rows('izobrazheniya', $post_id)) : the_row();
				if (have_rows('image')) :
					while (have_rows('image')) : the_row();
						$post_photos[] = get_sub_field('image');
					endwhile;
				endif;
			endwhile;
		endif;
