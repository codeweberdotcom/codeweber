            ...
            <article id="div-comment-<?php comment_ID(); ?>" class="comment-body">
               <footer class="comment-meta">
                  ...
                  <div class="comment-metadata">
                     ...
                     $comment_timestamp = sprintf(__('%1$s at %2$s', 'codeweber'), get_comment_date('', $comment), get_comment_time());
                     printf(
               ...
               <div class="comment-content entry-content">
                  ...
                  ?>
                     <p class="comment-awaiting-moderation"><?php _e('Your comment is awaiting moderation.', 'codeweber'); ?></p>
                  <?php
                  }
                  ?>
               </div><!-- .comment-content -->
               ...
               ?>
                  <footer class="comment-footer-meta">
                     ...
                     if ($by_post_author) {
                        echo '<span class="by-post-author">' . __('By Post Author', 'codeweber') . '</span>';
                     }
                     ?>
                  </footer>
               <?php
